# ComfyUI Portrait Master 2.9.2 (legacy)

This documentation is for the previous version of the node.
...
The [_portrait-master-workflow-SDXL.json_](/workflow/legacy/portrait-master-workflow-SDXL.json) file contains a **complete workflow** designed to work with **SDXL checkpoints**.
...
![Workflow](/screenshot/legacy/portrait-master-workflow-2.3.png)
...
The [_portrait-master-basic-workflow-SD1.5.json_](/workflow/legacy/portrait-master-basic-workflow-SD1.5.json) file contains a **basic workflow** designed to work with **SD1.5 checkpoints**.

![Workflow](/screenshot/legacy/portrait-master-workflow-2.3-SD1.5.png)
