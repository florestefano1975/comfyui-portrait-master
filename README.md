...
Thanks to the study of the user [NeuraLunk](https://openart.ai/workflows/neuralunk/quick-lcm-portraits-in-good-quality/ahoo51x5Y0z5QhEmF6HG) I have inserted some example images created with his workflow, which uses LCM for ultra-fast image generation, in the _examples-lcm_ folder.

With **Google Colab** and **GPU V100** you can generate **9 1024×1024 images** in less than **30 seconds**, with good quality.

This workflow can be interesting to study the options of my node with fast timing.
